...
public class Perifericos extends javax.swing.JFrame {
    ...
    public Perifericos() {
        ...
        for (Periferico periferico : perifericos) {
            ...
            fila.add(quitaGuion(periferico.getNombre()));
            md.addRow(fila);
        }
        tabla.setModel(md);
        
        btnAgregar.setEnabled(Loged.getLoged().isEditarPerifericos());
        btnEliminar.setEnabled(Loged.getLoged().isEditarPerifericos());
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        AgregarPeriferico ag = new AgregarPeriferico(perifericos);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        Eliminar el = new Eliminar(perifericos);
