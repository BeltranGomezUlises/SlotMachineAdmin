...
public class Editar extends javax.swing.JFrame {
    ...
    int indexEditar;
    public Editar(int indexEditar) {
        initComponents();
        chequeras = Chequera.cargarChequeras();
        this.indexEditar = indexEditar;
        txtId.setText(quitaGuion(chequeras.get(indexEditar).getId()));
        //llenar cmbRuteros
        ...
        cmbRutero.setSelectedItem(quitaGuion(chequeras.get(indexEditar).getRutero()));
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (!existe) {
            chequeras.set(indexEditar, c);
            Chequera.actualizarDB(chequeras);
            JOptionPane.showMessageDialog(null, "Chequera Editada con éxito");
